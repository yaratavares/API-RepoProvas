...
import createDataDisciplines from "./factories/createDataDisciplines.js";
import client from "../src/database.js";
beforeEach(truncateTables);
beforeAll(disconnect);
describe("Select disciplines - GET /filter/disciplines", function () {
    it("Should answer with array not empty when take disciplines that starts with 'a'", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createDataDisciplines()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, supertest(app).get("/filter/disciplines/".concat("Ja"))];
                case 2:
                    result = _a.sent();
